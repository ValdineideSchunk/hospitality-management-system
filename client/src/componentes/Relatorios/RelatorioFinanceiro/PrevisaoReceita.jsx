...
const PrevisaoReceita = () => {
    ...
    const gerarGraficoBarras = () => {
        ...
        return {
            ...
            datasets: [
                {
                    label: 'Previsão de Receita por Acomodação (R$)',
                    data,
    ...
    return (
        <div style={{
            ...
            {dadosRelatorio.length > 0 && (
                <div>
                    <h3>Tabela de Previsão de Receita</h3>
                    ...
                    <h3 className="mt-4">Receita Total Prevista: {formatarMoeda(receitaTotalPeriodo)}</h3>
                    ...
                    {tipoGrafico === 'barras' ? (
                        <div>
                            <h3 className="mt-5">Gráfico de Receita Prevista (Barras)</h3>
                        ...
                        <div>
                            <h3 className="mt-5">Gráfico de Receita Prevista (Pizza)</h3>
                            <div style={{ width: '60%', margin: '0 auto' }}>
                                <Pie
...
export default PrevisaoReceita;
